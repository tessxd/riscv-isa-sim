...
plt.plot(np.log(two_df['Cache Size'].tolist()),one_df['Miss Rate'], label='2 threads')
plt.plot(np.log(three_df['Cache Size'].tolist()),two_df['Miss Rate'], label='3 threads')
plt.plot(np.log(four_df['Cache Size'].tolist()),four_df['Miss Rate'], label='4 threads')
plt.plot(np.log(five_df['Cache Size'].tolist()),five_df['Miss Rate'], label='5 threads')
